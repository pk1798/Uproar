...
const smallContainer = document.getElementById('small-card-container');


function listSmallCard(arr){
    arr.forEach((card)=>{
...
listSmallCard(smallCard)



// const navbarMenu = document.getElementById('dropdownContentSecondary').querySelectorAll("a")

// navbarMenu.forEach(menu=>{
//     menu.addEventListener('click',function() {
//         navbarMenu.forEach(a=>a.classList.remove('active'))
//         this.classList.add('active')
//          var filtererArray = smallCard.filter(card => card.genre ==`${menu.id}`);
//          smallContainer.innerHTML = '';
//          listSmallCard(filtererArray)
//          console.log(filtererArray)
//     })
// })


const navMenu = document.getElementById('dropdownContentSecondary').querySelectorAll("a")

navMenu.forEach(menu=>{
    menu.addEventListener('click',function() {
        navMenu.forEach(a=>a.classList.remove('active'))
        this.classList.add('active')
        var filtererArray = card.filter(card => card.genre ==`${menu.id}`);
        var filtererSmallArray = smallCard.filter(card => card.genre ==`${menu.id}`);
        container.innerHTML = '';
        smallContainer.innerHTML = '';
        listCard(filtererArray)
        listSmallCard(filtererSmallArray)
         console.log(filtererArray)
         console.log(filtererSmallArray)
